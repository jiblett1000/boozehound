      ...
      <v-parallax 
        ...
        <v-layout 
          ...
          <h1 
            ...
            style="font-weight: 900; text-shadow: 3px 2px #000000">The social network for epic content
          </h1>
          <div 
            class="white--text subheading mb-3 text-xs-center" 
            style="font-weight: 900; text-shadow: 2px 2px #000000">Unlesh your creativity without limitations
          </div>
          <v-btn 
      ...
      >
        <v-flex 
          ...
          <div 
            ...
            <h2 
              class="headline">The best way to share your amazing stuff</h2>
            <span 
              class="subheading">
              ...
              <v-flex 
                ...
                <v-card 
                  ...
                  <v-card-text 
                    ...
                    <v-icon 
                      x-large 
                      class="blue--text text--lighten-2">public
                    </v-icon>
                  </v-card-text>
                  <v-card-title 
                    primary-title 
                    ...
                    <div 
                      class="headline text-xs-center">Reach the world
                    </div>
                  </v-card-title>
                  <v-card-text>
              ...
              <v-flex 
                ...
                <v-card 
                  ...
                  <v-card-text 
                    ...
                    <v-icon 
                      x-large 
                      class="blue--text text--lighten-2">flash_on
                    </v-icon>
                  </v-card-text>
                  <v-card-title 
                    primary-title 
              ...
              <v-flex 
                ...
                <v-card 
                  ...
                  <v-card-text 
                    ...
                    <v-icon 
                      x-large 
                      class="blue--text text--lighten-2">share
                    </v-icon>
                  </v-card-text>
                  <v-card-title 
                    primary-title 
                    class="layout justify-center">
                    <div 
                      class="headline text-xs-center">Create new connections
                    </div>
                  </v-card-title>
                  <v-card-text>
    ...
    <section>
      <v-parallax 
        ...
        <v-layout 
          ...
          justify-center>
          <div 
            class="headline white--text mb-3 text-xs-center">Endorfine is a social network that allows everyone to reach a huge audience with a tap </div>
      ...
      <v-container grid-list-md>
        <v-layout 
          ...
          <v-flex 
            ...
            <br>
            <div>We are lunching the beta in a few time. If you want to be one of the first Endorfine users we will email you as soon as we're ready. In the beginning only few people will test before the launch. Let us know how Endorfine will help you!
            </div>
          </v-flex>
          <v-flex 
            xs8 
            ...
            <v-card 
              ...
              <v-card-text>
                ...
                <v-flex 
                  ...
                  class="text-xs-center" >
                  <v-btn 
                    class="green lighten-2 mb-5" 
                    dark 
                    large>Welcome on board!
                  </v-btn>
                </v-flex>
              </v-card-text>
