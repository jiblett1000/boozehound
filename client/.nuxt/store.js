...
void (function updateModules() {
  ...
  resolveStoreModules(require('@/store/drinks.js'), 'drinks.js')
  resolveStoreModules(require('@/store/drinkware.js'), 'drinkware.js')
  resolveStoreModules(require('@/store/drawer.js'), 'drawer.js')
  resolveStoreModules(require('@/store/navSearch.js'), 'navSearch.js')
  resolveStoreModules(require('@/store/orders.js'), 'orders.js')
  resolveStoreModules(require('@/store/posItems.js'), 'posItems.js')
